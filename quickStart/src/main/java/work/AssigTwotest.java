...
public class AssigTwotest {
	...
	public static void main(String[] args) {
        ...
        JavaRDD<String> input =  sc.textFile("/Users/mac/workspace/learningSpark/quickStart/src/main/java/work/input.txt");
//        sc.textFile("graph").collect().forEach(System.out::println);;
        ...
        }, true, 1).saveAsTextFile("/Users/mac/workspace/learningSpark/quickStart/src/main/java/work/output");
	}
}
