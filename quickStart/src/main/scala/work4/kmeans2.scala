...
object kmeans2 {
  def main(args: Array[String]) {
    val conf = new SparkConf().setAppName("kmeans in Spark").setMaster("local[*]")
    val sc = new SparkContext(conf)
    val input = "/Users/mac/workspace/learningSpark/quickStart/src/main/scala/work4/point.txt" //args(0) //输入数据
    val output = "/Users/mac/workspace/learningSpark/quickStart/src/main/scala/work4/output"+System.currentTimeMillis()//args(1) //输出路径
    val k =  10//args(2).toInt //聚类个数
    var s = 0d //聚类效果评价标准
    val shold = 0.1 //收敛阀值
